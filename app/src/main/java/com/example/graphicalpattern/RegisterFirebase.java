    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(fAuth.getCurrentUser() != null){
            if(fAuth.getCurrentUser().isEmailVerified()){
                //todo patternpage
                startActivity(new Intent(getApplicationContext(),PatternPage.class));
                finish();
            }else {
                        ...
                        if(task.isSuccessful()){
                            ...
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(RegisterFirebase.this, "Verification Email Has been Sent.", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            Toast.makeText(RegisterFirebase.this, "User Created.", Toast.LENGTH_SHORT).show();
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //user = fAuth1.getCurrentUser();
                //if(user.isEmailVerified()){
                startActivity(new Intent(getApplicationContext(),LoginFirebase.class));
                //}else {
                 //   Toast.makeText(RegisterFirebase.this, "Please verify the email-Id", Toast.LENGTH_SHORT).show();
                //}
